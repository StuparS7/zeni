module.exports = {
  ...
  AMMO_PICKUP_AUTO_RADIUS: 5.0,
  AMMO_PICKUP_AMOUNT: 20,
  AMMO_PICKUP_RESPAWN_MS: 12000,
  VEHICLE_SPEED: 16,
  VEHICLE_ACCEL: 28,
  VEHICLE_TURN_SPEED: 2.0,
  VEHICLE_DRAG: 5.0,
  VEHICLE_DRIFT_DRAG: 1.4,
  VEHICLE_GRIP: 8.0,
  VEHICLE_DRIFT_GRIP: 1.6,
  VEHICLE_MAX_STEER: 0.55,
  VEHICLE_RADIUS: 1.6,
  ...
  ZOMBIE_SPAWN_INTERVAL_MS: 2400,
  ZOMBIE_MAX: 40,
  ZOMBIE_SPAWN_NEAR_MIN: 14,
  ZOMBIE_SPAWN_NEAR_MAX: 26,
  ROUND_DURATION_MS: 120000,
  KILL_POINTS: 60,
  WORLD_BOUNDS: { minX: -360, maxX: 360, minY: -240, maxY: 240 }
};
